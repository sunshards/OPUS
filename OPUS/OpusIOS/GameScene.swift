...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        motionManager.startDeviceMotionUpdates(to: .main) {  (motion, error) in
            ...
            print("x: \(motion.attitude.roll), y: \(motion.attitude.pitch), z: \(motion.attitude.yaw)")   // Rotation around x-axis (rad)
//            print("") // Rotation around y-axis (rad)
//            print("Yaw: ")     // Rotation around z-axis (rad)
